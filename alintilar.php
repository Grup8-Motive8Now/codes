...
<header>
    ...
    <div class="logo">
        ...
        <h1 style="text-align: center; color: #474747;">MOTİVASYONEL ALINTILAR</h1>
    </div>
    <container>
        <div class="category-groups">
            <div class="category-group">
                <div class="category-box" style="background-color: #FFE3E3;">
                    <h2><a href="category1.php">BAŞARI VE HEDEFLER</a></h2>
                </div>
                <div class="category-box" style="background-color: #FFE3E3;">
                    <h2><a href="category2.php">İŞ VE KARİYER</a></h2>  
                </div>
                <div class="category-box" style="background-color: #FFE3E3;">
                    <h2><a href="category3.php">KİŞİSEL GELİŞİM</a></h2>
                </div>
            </div>

            <div class="category-group">
                <div class="category-box" style="background-color: #FFCDCD;">
                    <h2><a href="category4.php">AİLE VE EVLİLİK</a></h2>
                </div>
                <div class="category-box" style="background-color: #FFCDCD;">
                   <h2><a href="category5.php">İLİŞKİLER VE AŞK</a></h2>  
                </div>
                <div class="category-box" style="background-color: #FFCDCD;">
                    <h2><a href="category6.php">ARKADAŞLIK VE DOSTLUK</a></h2>
            ...
            <div class="category-group">
                <div class="category-box" style="background-color: #B396BD;">
                    <h2><a href="category7.php">SAĞLIK VE SPOR</a></h2>
                   
                </div>
                <div class="category-box" style="background-color: #B396BD;">
                   <h2><a href="category8.php">MOTİVASYON VE DİSİPLİN</a></h2>
                </div>
                <div class="category-box" style="background-color: #B396BD;">
                    <h2><a href="category9.php">OLUMLU DÜŞÜNCE VE ZİHİN SAĞLIĞI</a></h2>
            ...
            <div class="category-group">
                <div class="category-box" style="background-color: #ABB5BF;">
                    <h2><a href="category10.php">SANAT VE YARATICILIK</a></h2>
                </div>
                <div class="category-box" style="background-color: #ABB5BF;">
                   <h2><a href="category11.php">DOĞA VE ÇEVRE</a></h2> 
                    
                </div>
                <div class="category-box" style="background-color: #ABB5BF;">
                    <h2><a href="category12.php">SEYAHAT VE KEŞİF</a></h2>
            ...
            <div class="category-13">
                <div class="category-box" style="background-color: #b4a0cf;">
                   <h2><a href="category13.php">KARIŞIK ALINTILAR</a></h2> 
