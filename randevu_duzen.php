...
<html>
    ...
    <div class="column">
        ...
        <form action="randevu_duzen_do.php" method="POST">
            ...
            Uzman Seçiniz:<select name="rtercih">
            <option value="Uzman1">Uzman1</option>
            <option value="Uzman2">Uzman2</option>
            <option value="Uzman3">Uzman3</option>
            <option value="Uzman4">Uzman4</option>
        </select><br /><br />
