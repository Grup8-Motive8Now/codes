...
<header>
    ...
    <div class="container">
        ...
        <p style="font-style: italic;">Motiv8Now, kullanıcılarına yorucu hayat temposu sırasında kendilerini tekrar
            bulmalarını ve gerekli motivasyonu olumlu materyaller ile kullanıcılarına sunmak üzerine
            tasarlanmış bir web sitesidir. İlham verici içerikleri ve çesitliligi, kisisellestirilmis
            içerikleri ve kolay erisilebilirliginin yanı sıra ücretsiz olmasıyla sizlere hizmet etmeyi
            amaçlamaktadır.
            Web ve mobil platformlarda uyumlu çalısması sebebiyle
            günün her anında sizin yanınızdadır.
            Amacımız size zorluklarla başa çıkabilmeniz için gerekli araçaları sunmak ve hayatınızda
            olumlu değişiklikler yapabilmenizi sağlamaktır.Yenilenen içeriklerimizle, her zaman yeni bir
            motivasyon kaynağına sahip olacak ve hedeflerinize daha hızlı ve kolay bir şekilde ulaşabileceksiniz.
        </p>
    </div>
</body>
